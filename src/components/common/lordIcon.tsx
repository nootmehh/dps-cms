...
// Name mapping to lord-icons files in public/lord-icons/system and public/lord-icons/lineal
export const LORD_ICON_MAP: Record<string, string> = {
  ...
  Pen: "/lord-icons/system/system-outline-4062-pencil-line-hover-pinch.json",
  pen: "/lord-icons/system/system-outline-4062-pencil-line-hover-pinch.json",
  Pencil: "/lord-icons/system/system-outline-4062-pencil-line-hover-pinch.json",
  pencil: "/lord-icons/system/system-outline-4062-pencil-line-hover-pinch.json",
  ...
  "check-circle-tick": "/lord-icons/system/system-outline-24-check-circle-morph-tick.json",
  CrossCircle: "/lord-icons/system/system-outline-25-cross-circle-hover-pinch.json",
  "cross-circle": "/lord-icons/system/system-outline-25-cross-circle-hover-pinch.json",
  "check-cross": "/lord-icons/system/system-outline-25-cross-circle-hover-pinch.json",
  ...
  "info-circle": "/lord-icons/system/system-outline-367-info-circle-hover-pinch.json",
  "input-pin": "/lord-icons/system/system-outline-384-input-pin-hover-pinch.json",
  InputPin: "/lord-icons/system/system-outline-384-input-pin-hover-pinch.json",
  Pin: "/lord-icons/system/system-outline-384-input-pin-hover-pinch.json",
  ...
  "arrow-right": "/lord-icons/system/system-outline-230-arrow-right-hover-slide.json",
  ArrowRight: "/lord-icons/system/system-outline-230-arrow-right-hover-slide.json",
